...
public class ZuoBiao extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (canvas != null) {
            ...
            for(float x=-2*centerX;x<2*centerY;x+=0.001){
                //canvas.drawPoint(po.x+x,po.y-(float)(a*Math.sin(b*x)),paint);//,2*(float)Math.PI,2
            }
        }
    ...
    /*private void drawPoint(Canvas canvas,Paint paint,float x,float y,float halfWidth,float halfHeight){
        canvas.drawPoint(canvas,paint,200/2f/halfWidth*x,400/2f/halfHeight*y);
    }*/
